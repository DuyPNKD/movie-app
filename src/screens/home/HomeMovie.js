        ...
        <ScrollView style={styles.scrollView}>
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    <CategoryHome title="Xu Hướng" component="CategoryTrending" data={data} navigation={navigation} />
                    <CategoryHome title="Phổ Biến" component="CategoryPopular" data={data} navigation={navigation} />
                    <CategoryHome title="Đánh Giá Cao" component="CategoryTopRated" data={data} navigation={navigation} />
                    <CategoryHome title="Đề Xuất Cho Bạn" component="CategoryRecommend" data={data} navigation={navigation} />
                    <CategoryHome title="Phim Thiếu Nhi" component="CategoryKid" data={data} navigation={navigation} />
                    <CategoryHome title="Phiêu Lưu" component="CategoryAdventure" data={data} navigation={navigation} />
                    <CategoryHome title="Lãng Mạn" component="CategoryRomance" data={data} navigation={navigation} />
