...
const CategoryHome = ({title, data, component, navigation}) => (
    <View style={styles.category}>
        ...
        <FlatList
            data={data}
            renderItem={({item}) => (
                <TouchableOpacity style={styles.movie} onPress={() => navigation.navigate("DetailPage", {id: item.id})}>
                    <Image source={require("../../../assets/home/home.png")} style={styles.movieImage} />
